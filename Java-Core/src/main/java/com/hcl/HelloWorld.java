...
public class HelloWorld {
	...
	public static void main(String[] args) 
	{
		...
		switch(num)
		{
		case 4: System.out.println("It is 4"); break;
		...
		System.out.println("1: 43 " + calc1);
		System.out.println("1: 1 " + calc2);
		System.out.println("1: 19 " + calc3);
		System.out.println("1: 13 " + calc4);*/
		...
		boolean prime;
		Scanner input = new Scanner(System.in);
		System.out.println("Enter a nubmer to check if it is prime: ");
		test = input.nextInt();
		prime = isPrime(test);
		...
		System.out.println("Enter a positive integer ");
		num = input.nextInt();
		res = sumOfSquaresOfEvenDigits(num);
	...
	/*public static boolean isPrime(int num)
	{
		...
		//Edge condition could be better, it's something like the
		// square root of num? But it would still be linear.
	...
	/*public static int checkSum(int num)
	{
		if (num < 0)
			return 0;
		// For the purposes of this assignment 0 is even (could also be made invalid)
		if (num == 0)
			return -1;
		if (num == 1)
			return 1;
